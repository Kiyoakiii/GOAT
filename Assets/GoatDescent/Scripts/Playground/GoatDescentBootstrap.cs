...
namespace GoatDescent
{
    ...
    public sealed class PrototypeHud : MonoBehaviour
    {
        ...
        private void OnGUI()
        {
            ...
            GUI.Label(new Rect(25, 56, 850, 25), "WASD — движение   Space — короткий прыжок   Ctrl — тормоз", copy);
            GUI.Label(new Rect(25, 77, 850, 25), "F — суперкопыта у скалы   R — начать снова   Esc — курсор", copy);
            ...
            var grip = goat ? goat.GetComponent<GoatGripController>() : null;
            GUI.Label(new Rect(25, 125, 750, 25), $"Суперкопыта: {(grip ? grip.SuperCharge01 * 100f : 0f):0}%", copy);
